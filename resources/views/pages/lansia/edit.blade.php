                    ...
                    <div class="step" data-target="#personal-info">
                        <button type="button" class="step-trigger">
                            ...
                            <span class="bs-stepper-label">
                                ...
                                <span class="bs-stepper-subtitle">Edit Biodata Lansia</span>
                            </span>
                        </button>
                    </div>
                </div>
                    ...
                    <form action="{{ route('lansia.update', $lansia->id) }}" method="POST">
                            ...
                            <div class="row g-6">
                                <div class="col-sm-6">
                                  ...
                                  <input type="text" id="username" name="username" class="form-control"
                                        value="{{ old('username', $lansia->user->username) }}" required />
                                    @error('username')
                        ...
                        <div id="personal-info" class="content">
                            <div class="content-header mb-4">
                                ...
                                <small>Edit Biodata Lansia.</small>
                            </div>
                            <div class="row g-6">
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-check form-check-inline mt-2">
                                        <input class="form-check-input" type="radio" name="jenis_kelamin" id="jenis_kelamin_l" value="L" 
                                            {{ old('jenis_kelamin', $lansia->jenis_kelamin) == 'L' ? 'checked' : '' }} required>
                                        <label class="form-check-label" for="jenis_kelamin_l">Laki-laki</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="jenis_kelamin" id="jenis_kelamin_p" value="P" 
                                            {{ old('jenis_kelamin', $lansia->jenis_kelamin) == 'P' ? 'checked' : '' }}>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control" id="ttl" name="ttl"
                                        value="{{ old('ttl', $lansia->ttl) }}" required />
                                    @error('ttl')
                                        <div class="text-danger mt-1">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-sm-6">
                                    ...
                                    <input class="form-control" type="number" id="umur" name="umur"
                                        value="{{ old('umur', $lansia->umur) }}" required />
                                    @error('umur')
                                        <div class="text-danger mt-1">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-sm-6">
                                    ...
                                    <select class="form-control" id="desa_id" name="desa_id" required>
                                        ...
                                        @foreach($desas as $desa)
                                            <option value="{{ $desa->id }}" {{ old('desa_id', $lansia->desa_id) == $desa->id ? 'selected' : '' }}>{{ $desa->nama_desa }}</option>
                                        @endforeach
                                    </select>
                                    @error('desa_id')
                                        <div class="text-danger mt-1">{{ $message }}</div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <textarea class="form-control" id="alamat" name="alamat" rows="3" required>{{ old('alamat', $lansia->alamat) }}</textarea>
                                    @error('alamat')
                                        <div class="text-danger mt-1">{{ $message }}</div>
                                    @enderror
                                </div>
